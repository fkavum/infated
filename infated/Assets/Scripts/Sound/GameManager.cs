...
{	
	...
	/// </summary>
	public enum CoreEngineEventTypes
	{
		LevelStart,
		LevelComplete,
		LevelEnd,
	...
	/// </summary>
	public struct CoreEngineEvent
	{
		public CoreEngineEventTypes EventType;
		/// <summary>
		/// Initializes a new instance of the <see cref="MoreMountains.CorgiEngine.CorgiEngineEvent"/> struct.
		/// </summary>
		/// <param name="eventType">Event type.</param>
		public CoreEngineEvent(CoreEngineEventTypes eventType)
		{
			EventType = eventType;
		}
	} 
	...
	public struct CoreEngineStarEvent
	{
		public string SceneName;
		public int StarID;

		public CoreEngineStarEvent(string sceneName, int starID)
		{
			SceneName = sceneName;
			StarID = starID;
		}
	...
	/// </summary>
	public struct CoreEnginePointsEvent
	{
		...
		public CoreEnginePointsEvent(PointsMethods pointsMethod, int points)
		{
	...
	public class PointsOfEntryStorage
	{
		...
		public CharacterStates.FacingDirections FacingDirection;

		public PointsOfEntryStorage(string levelName, int pointOfEntryIndex, CharacterStates.FacingDirections facingDirection)
		{
			LevelName = levelName;
	...
	/// </summary>
	[AddComponentMenu("Core Engine/Managers/Game Manager")]
	public class GameManager : 	PersistentSingleton<GameManager>, 
								InfEventListener<InfGameEvent>,
                                InfEventListener<CoreEngineEvent>,
                                InfEventListener<CoreEnginePointsEvent>
	{		
		[Header("Settings")]
		...
		{
			Points = 0;
            //InfEventManager.TriggerEvent(new InfTimeScaleEvent(MMTimeScaleMethods.Set, 1f, 0f, false, 0f, false));
			Paused = false;
		...
		{	
            ...
            {
                //InfEventManager.TriggerEvent(new InfTimeScaleEvent(InfTimeScaleMethods.For, 0f, 0f, false, 0f, true));
	  ...
	  //      }
		...
		public virtual void StorePointsOfEntry(string levelName, int entryIndex, CharacterStates.FacingDirections facingDirection)
		{
		...
		public virtual void OnInfEvent(InfGameEvent gameEvent)
		{
		...
		public virtual void OnInfEvent(CoreEnginePointsEvent pointEvent)
		{
		...
		protected virtual void OnEnable()
		{
			...
			this.InfEventStartListening<CoreEngineEvent> ();
			this.InfEventStartListening<CoreEnginePointsEvent> ();
		}
		...
		protected virtual void OnDisable()
		{
			...
			this.InfEventStopListening<CoreEngineEvent> ();
			this.InfEventStopListening<CoreEnginePointsEvent> ();
		}
	}
}