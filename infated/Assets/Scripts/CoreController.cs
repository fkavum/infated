...
{	
	...
	// DISCLAIMER : this controller's been built from the ground up for the Core Engine. It takes clues and inspirations from various methods and articles freely 
	...
	/// </summary>
	[AddComponentMenu("Core Engine/Character/Core/Core Controller")] 
	public class CoreController : MonoBehaviour 
	{
		/// the various states of our character
		public CoreControllerState State { get; protected set; }
		/// the initial parameters
		[Header("Default Parameters")]
		public CoreControllerParameters DefaultParameters;
		/// the current parameters
		public CoreControllerParameters Parameters{get{return _overrideParameters ?? DefaultParameters;}}
		...
		protected CoreControllerParameters _overrideParameters;
		...
		/// <summary>
		/// If the CoreController is standing on a moving platform, we match its speed
		/// </summary>
		...
		/// <summary>
		/// Disconnects the CoreController from its current moving platform.
		/// </summary>
   ...
   //         }
		...
		/// </summary>
		protected virtual void OnCoreColliderHit() 
		{
		...
		{
            /*
			CoreControllerPhysicsVolume2D parameters = collider.gameObject.GetComponentNoAlloc<CoreControllerPhysicsVolume2D>();
			if (parameters != null)
			{
