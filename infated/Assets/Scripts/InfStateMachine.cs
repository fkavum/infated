...
namespace Infated.Tools
{
	public struct InfStateChangeEvent<T> where T: struct, IComparable, IConvertible, IFormattable
	{
		...
		public InfStateMachine<T> TargetStateMachine;
		public T NewState;
	...
	/// </summary>
	public interface InfIStateMachine
	{
	...
	/// </summary>
	public class InfStateMachine<T> : InfIStateMachine where T : struct, IComparable, IConvertible, IFormattable
	{
		...
		public InfStateMachine(GameObject target, bool triggerEvents)
		{
			this.Target = target;
