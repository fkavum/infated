...
{	
	...
	public class CharacterCrouch : CharacterAbility 
	{
		...
		{
			InfAnimator.UpdateAnimatorBool(_animator,"Crouching",(_movement.CurrentState == CharacterStates.MovementStates.Crouching), _character._animatorParameters);			
			InfAnimator.UpdateAnimatorBool(_animator,"Crawling",(_movement.CurrentState == CharacterStates.MovementStates.Crawling), _character._animatorParameters);
		}
