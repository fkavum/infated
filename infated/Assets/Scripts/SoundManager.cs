...
{	
	...
	public class SoundManager : PersistentSingleton<SoundManager>, InfEventListener<InfSfxEvent>, InfEventListener<CoreEngineEvent>, InfEventListener<InfGameEvent>
	{	
		[Header("Settings")]
		...
		protected const string _saveFolderName = "CoreEngine/";
        ...
        void Start()
        {
            //if (bgm) PlayBackgroundMusic(bgm);
        }
        /// <summary>
        /// Plays a sound
        /// </summary>
		...
		public virtual void OnInfEvent(InfSfxEvent sfxEvent)
		{
		...
		{
			this.InfEventStartListening<InfSfxEvent>();
		...
		protected virtual void OnDisable()
		{
			if (_enabled)
			{
				this.InfEventStopListening<InfSfxEvent>();	
